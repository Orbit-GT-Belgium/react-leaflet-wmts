...
var _default = _leaflet.default.TileLayer.extend({
  ...
  getTileUrl: function getTileUrl(coords) {
    ...
    var enablePrefixTileMatrix = new Boolean(this.wmtsParams.enablePrefixTileMatrix)
    var prefixTileMatrix = "";
    if(new Boolean(this.wmtsParams.enablePrefixTileMatrix)) prefixTileMatrix = this.wmtsParams.tilematrixSet + ":"
    ...
    delete this.wmtsParams.leaflet;
    return url + _leaflet.default.Util.getParamString(this.wmtsParams, url) + "&tilematrix=" + prefixTileMatrix +  ident + '&tilerow=' + tilerow + '&tilecol=' + tilecol;
